...
//
// The one and only COpenALI3dl2App object.
//
COpenALI3dl2App theApp;
...
BEGIN_MESSAGE_MAP(COpenALI3dl2App, CWinApp)
    //{{AFX_MSG_MAP(COpenALI3dl2App)
    //}}AFX_MSG
...
//*****************************************************************************
//
COpenALI3dl2App::COpenALI3dl2App()
{
}
...
//*****************************************************************************
//
BOOL COpenALI3dl2App::InitInstance()
{
    //
    ...
    I3dl2Get = (I3DL2Get)alGetProcAddress((ALubyte*)"I3DL2Get");
    I3dl2Set = (I3DL2Set)alGetProcAddress((ALubyte*)"I3DL2Set");
    if(!I3dl2Get || !I3dl2Set)
    {
        MessageBox(0, "Failed to set get the addresses of the I3DL2Get and/or I3DL2Set !", "Error", MB_OK);
        PostQuitMessage(0);
        return FALSE;
    }
