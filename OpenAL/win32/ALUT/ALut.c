...
ALUTAPI ALvoid ALUTAPIENTRY alutInit(ALint* argc, ALbyte** argv)
{
    ...
    device = alcOpenDevice((ALubyte*)&mixerCaps.szPname);
    if(!device)
    {
        //Open device
...
ALUTAPI ALvoid ALUTAPIENTRY alutLoadWAVFile(ALbyte* file, ALenum* format, ALvoid** data, ALsizei* size, ALsizei* freq, ALboolean* loop)
{
    ...
    ALenum AL_FORMAT_MONO8    = alGetEnumValue("AL_FORMAT_MONO8");
    ALenum AL_FORMAT_MONO16   = alGetEnumValue("AL_FORMAT_MONO16");
    ALenum AL_FORMAT_STEREO8  = alGetEnumValue("AL_FORMAT_STEREO8");
    ALenum AL_FORMAT_STEREO16 = alGetEnumValue("AL_FORMAT_STEREO16");
