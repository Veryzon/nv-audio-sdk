...
extern "C" {
    ...
    */
    typedef ALenum (ALAPIENTRY *EAXSet)(const GUID* propertySetID, ALuint property, ALuint sourceName, ALvoid* value, ALuint size);
    typedef ALenum (ALAPIENTRY *EAXGet)(const GUID* propertySetID, ALuint property, ALuint sourceName, ALvoid* value, ALuint size);

    #ifndef AL_NO_PROTOTYPES
        ALenum ALAPIENTRY EaxSet(const GUID* propertySetID, ALuint property, ALuint sourceName, ALvoid* value, ALuint size);
        ALenum ALAPIENTRY EaxGet(const GUID* propertySetID, ALuint property, ALuint sourceName, ALvoid* value, ALuint size);
...
} EAX_REVERBPROPERTIES, *LPEAX_REVERBPROPERTIES;
...
} EAXBUFFER_REVERBPROPERTIES, *LPEAXBUFFER_REVERBPROPERTIES;
